...
namespace Microsoft.AspNetCore.Routing.Matching
{
    public class DfaMatcherBuilderTest
    {
        ...
        {
            // Arrange
            var builder = CreateDfaMatcherBuilder(useLegacy30CatchAllBehavior: true);
        ...
        private static DfaMatcherBuilder CreateDfaMatcherBuilder(bool useLegacy30CatchAllBehavior, params MatcherPolicy[] policies)
        {
            var policyFactory = CreateParameterPolicyFactory();
            var dataSource = new CompositeEndpointDataSource(Array.Empty<EndpointDataSource>());
            return new DfaMatcherBuilder(
